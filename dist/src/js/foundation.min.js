...
KeyboardListener.bind=bind;function clear(key){if(typeof key==='string'){delete methods[key];}
else{key.forEach(function(k){delete methods[k];});}}
KeyboardListener.clear=clear;})(KeyboardListener||(KeyboardListener={}));var KaiUI;(function(KaiUI){var SoftkeyHandler=(function(){function SoftkeyHandler(){this.element=new ReactiveElement({selector:'#kai-softkey-container',data:{labelLeft:'',labelCenter:'',labelRight:''},template:"\n\t\t\t\t<label class=\"kai-softkey-left\">{{labelLeft}}</label>\n\t\t\t\t<label class=\"kai-softkey-center\">{{labelCenter}}</label>\n\t\t\t\t<label class=\"kai-softkey-right\">{{labelRight}}</label>\n\t\t\t"});}
Object.defineProperty(SoftkeyHandler.prototype,"visible",{get:function(){var _a;return(_a=this.element.innerElement)===null||_a===void 0?void 0:_a.classList.contains('hidden');},set:function(value){var _a,_b;switch(value){case false:(_a=this.element.innerElement)===null||_a===void 0?void 0:_a.classList.add('hidden');break;case true:(_b=this.element.innerElement)===null||_b===void 0?void 0:_b.classList.remove('hidden');break;}},enumerable:false,configurable:true});SoftkeyHandler.prototype.bind=function(key,label,method){switch(key){case KeyboardKey.SoftLeft:this.element.labelLeft=label;break;case KeyboardKey.Enter:this.element.labelCenter=label;break;case KeyboardKey.SoftRight:this.element.labelRight=label;break;};KeyboardListener.bind(key,method.bind(this));};SoftkeyHandler.prototype.clear=function(visible){if(visible===void 0){visible=true;}
KeyboardListener.clear([KeyboardKey.SoftLeft,KeyboardKey.Enter,KeyboardKey.SoftRight]);this.element.reset();this.visible=visible;};return SoftkeyHandler;}());KaiUI.SoftkeyHandler=SoftkeyHandler;var ViewManager=(function(){function ViewManager(){this.stack=[];this.element=new ReactiveElement({selector:'#kai-view-container',data:{content:''},template:'{{content}}'});}
